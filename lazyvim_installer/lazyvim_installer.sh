...
detect_os_and_package_manager() {
    ...
    echo -e "💻 OS rilevato: \e[32m$OS_TYPE\e[0m | Distribuzione: \e[33m$DISTRO\e[0m | Package Manager: \e[36m$PACKAGE_MANAGER\e[0m\n"
}
...
case $PACKAGE_MANAGER in
    ...
    *) echo "⚠️ Package manager sconosciuto. Uscita."; exit 1 ;;
esac
